...
import { Card, Container, Content, ContentCards, StyleBreadcrumb, Title } from "./styles";
        ...
        <i class="fa-solid fa-users-gear"></i>
          ...
          <div>
            ...
            <ContentCards>
              ...
              <Card >
                <img style={{border:"1px solid #d1d5db "}} src={ImgLogo1} alt="" />
               
              </Card>
              <Card>
                <img style={{border:"1px solid #d1d5db "}} src={ImgLogo1} alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTY_SWYl0g1FVsROYA9yFW-w8wwaqlVwwuu-DRV-hzhe4r8MMLHLPUTYiH-iAJjnlwVnq4&usqp=CAU" alt="" />
